...
const scheduleData = {
  1: {
    ...
    events: [
      { time: "09:00 AM", title: "Marketplace Stalls", description: "Continued showcase of handmade, biodegradable, sustainable, and rooted products.", tag: "MARKETPLACE", tagColor: "bg-green-500" },
  ...
  2: {
    ...
    events: [
      { time: "09:00 AM", title: "Marketplace Stalls (Continued)", description: "Continued showcase of handmade, biodegradable, sustainable, and rooted products.", tag: "MARKETPLACE", tagColor: "bg-green-500" },
    ...
    <div className="bg-[#F3E9DD] min-h-screen" style={{ backgroundImage: `radial-gradient(circle, rgba(0,0,0,0.02) 10%, transparent 10%)`, backgroundSize: '20px 20px' }}>
      ...
      <main>
        ...
        <section className="py-16 px-4">
          {/* This container manages the animated transitions between schedules */}
          {Object.keys(scheduleData).map(dayKey => {
            const isActive = parseInt(dayKey) === activeDay;
            return (
              <div
                key={dayKey}
                // We use grid to animate the height from 0 to its full content height.
                // This is a modern and reliable way to create a smooth "accordion" or "pop-up" effect.
